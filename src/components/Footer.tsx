...
export default function Footer() {
  return (
    <nav className="flex items-center justify-between border-t border-gray-200 p-8 sm:px-0">
      <div className="-mt-px flex w-0 flex-1">
        <a
          href="#"
          className="inline-flex items-center border-t-2 border-transparent pt-4 px-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700 "
        >
          <ArrowLongLeftIcon
            aria-hidden="true"
